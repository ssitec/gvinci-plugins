...
Public Class clsRuleDynamicallyCompiled_R4717
    ...
    ' 
        ...
        P13420 = IIf(IsDBNull(P13420), "NULO", P13420)
...
ConvertValue(P13143, 1, DecimalSymbol, DateIdentifier, StringIdentifier, "dd-MM-yyyy HH:mm:ss") & " "
    ...
    Comp_C159439:
        ...
        QueryC159439.CommandText = QueryC159439.CommandText & " " & "SELECT NVL(MAX(WF_PRE_PEDIDO_OBS.Departamento), 'NULO')"
        QueryC159439.CommandText = QueryC159439.CommandText & " " & "FROM  AKBUSER01.WF_PRE_PEDIDO_OBS "

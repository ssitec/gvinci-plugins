...
Public Class clsRuleDynamicallyCompiled_R14036
    ...
    ' 
    ' 14036 - Monta Lista de Departamentos - Versão: 0
    ' 
        'On Error GoTo Err_R14036
        Dim sCurrComponent as String

        Dim C295347DataType() As Short
        Dim C295349 As Object
        Dim C295349DataType As Short
    ...
    Comp_C295349:
        ...
        ' ListaDeptoLib
        sCurrComponent = "ListaDeptoLib"
        C295349DataType = 5
        C295349 = ""
            If RTrim(C295349) <> "" Then
                C295349 = C295349 & ", "
            End If
            C295349 = C295349 & ConvertValue(C295356, 0, DecimalSymbol, DateIdentifier, StringIdentifier, "dd-MM-yyyy HH:mm:ss")
        Loop

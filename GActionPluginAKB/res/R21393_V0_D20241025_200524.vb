...
Public Class clsRuleDynamicallyCompiled_R21393
    ...
    ' 
        ...
        Dim C579523 As Object
        Dim C579523DataType As Short
        Dim C579524 As Boolean
        Dim C579524DataType As Short
...
P82033 & " ." & Chr(13) & Chr(10) & "Ok" & Chr(13) & Chr(10)
    ...
    Comp_C579523:
        ...
        ' FIM_Taxas
        sCurrComponent = "FIM_Taxas"
        C579523DataType = 4
        C579523 = RsC508129_EOF
        GoTo Comp_C579524

    Comp_C579524:

        ' FIM_Taxas = 1
        sCurrComponent = "FIM_Taxas = 1"
        C579524 = (fn_ConvertValueCompiled(C579523, C579523DataType, AKB_DecimalPoint, False) = 1)
        C579524DataType = AKBTypeConst.cAKBTypeLogical
        If C579524 Then
            GoTo Comp_C508133
        Else
            GoTo Comp_C508130

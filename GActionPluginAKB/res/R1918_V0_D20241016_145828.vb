...
ConvertValue(P3443, 3, DecimalSymbol, DateIdentifier, StringIdentifier, "dd-MM-yyyy HH:mm:ss") & ",15,' ')"
    ...
    Comp_C13130:
        ...
        row_C13130(0) = "Já existe um pedido com esse número. " & Chr(13) & "" & Chr(10) & "Número do Pedido da Empresa." & Chr(13) & "" & Chr(10) & "Deseja Gravar?" & Chr(13) & Chr(10) & "Sim" & Chr(13) & Chr(10)

...
Public Class clsRuleDynamicallyCompiled_R1770
    ...
    Public Shared Function R1770(ByRef con As OracleConnection, ByRef txn As OracleTransaction) As DataTable
    ' 
    ' 1770 - Estabelecimento Default - Versão: 0
    ' 
        On Error GoTo Err_R1770
        Dim sCurrComponent as String

        Dim QueryC11595 As New Object
        Dim RsC11595 As New Object
        Dim C11595DataType() As Short
        Dim RsC11595_EOF As Boolean
        Dim C11596DataType() As Short
        Dim C260427 As Object
        Dim C260427DataType As Short
    ...
    Comp_C11595:
        ...
        ' Sel_Estab_Default
        sCurrComponent = "Sel_Estab_Default"
        QueryC11595 = con.CreateCommand()
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "SELECT WF_PESSOAS.Nome_Pessoa , WF_PESSOAS.Cod_Pessoa , WF_ESTAB_JURIDICO.Abreviatura , "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "                   WF_CIDADES.Cidade , WF_ESTAB_JURIDICO_PARAM.Cod_Estab_Faturamento "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & ""
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "FROM AKBUSER01.WF_PESSOAS , AKBUSER01.WF_ESTAB_JURIDICO , AKBUSER01.WF_CIDADES , AKBUSER01.WF_ESTAB_JURIDICO_PARAM "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "WHERE WF_PESSOAS.Cod_Pessoa = WF_ESTAB_JURIDICO.Cod_Pessoa_Estab_Juridico "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND  WF_ESTAB_JURIDICO.Estabelecimento_Default = 1 "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND  WF_CIDADES.Codigo_Cidade = WF_PESSOAS.Codigo_Cidade "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND  WF_ESTAB_JURIDICO_PARAM.Cod_Pessoa_Estab_Juridico = WF_ESTAB_JURIDICO.Cod_Pessoa_Estab_Juridico "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & ""
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND Not Exists ( Select WF_LOGIN_X_ESTAB.Cod_Pessoa_Estab_Juridico "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "                                  from AKBUSER01.WF_LOGIN_X_ESTAB "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "                                  where WF_LOGIN_X_ESTAB.Login = " & _ 
ConvertValue(C260427, C260427DataType, DecimalSymbol, DateIdentifier, StringIdentifier, "dd-MM-yyyy HH:mm:ss") & " "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "                                  and WF_LOGIN_X_ESTAB.Estab_Default = 1)"
        QueryC11595.CommandText = QueryC11595.CommandText & " " & ""
        QueryC11595.CommandText = QueryC11595.CommandText & " " & ""
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "Union all"
        QueryC11595.CommandText = QueryC11595.CommandText & " " & ""
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "SELECT WF_PESSOAS.Nome_Pessoa , WF_PESSOAS.Cod_Pessoa , WF_ESTAB_JURIDICO.Abreviatura , "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "                   WF_CIDADES.Cidade , WF_ESTAB_JURIDICO_PARAM.Cod_Estab_Faturamento "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "FROM AKBUSER01.WF_LOGIN_X_ESTAB , AKBUSER01.WF_PESSOAS , AKBUSER01.WF_ESTAB_JURIDICO , AKBUSER01.WF_CIDADES , AKBUSER01.WF_ESTAB_JURIDICO_PARAM "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & ""
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "WHERE WF_LOGIN_X_ESTAB.Estab_Default = 1 "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND WF_LOGIN_X_ESTAB.Login = " & _ 
ConvertValue(C260427, C260427DataType, DecimalSymbol, DateIdentifier, StringIdentifier, "dd-MM-yyyy HH:mm:ss") & " "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND WF_LOGIN_X_ESTAB.Cod_Pessoa_Estab_Juridico = WF_ESTAB_JURIDICO.Cod_Pessoa_Estab_Juridico"
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND  WF_PESSOAS.Cod_Pessoa = WF_LOGIN_X_ESTAB.Cod_Pessoa_Estab_Juridico "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND  WF_CIDADES.Codigo_Cidade = WF_PESSOAS.Codigo_Cidade "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & "AND  WF_ESTAB_JURIDICO_PARAM.Cod_Pessoa_Estab_Juridico = WF_ESTAB_JURIDICO.Cod_Pessoa_Estab_Juridico "
        QueryC11595.CommandText = QueryC11595.CommandText & " " & ""
        QueryC11595.Transaction = txn
        RsC11595 = QueryC11595.ExecuteReader()
        Dim iC11595 As Short
        ReDim C11595DataType(RsC11595.FieldCount)
        For iC11595 = 0 to RsC11595.FieldCount - 1
            Select Case RsC11595.GetDataTypeName(iC11595).ToUpper()
                Case "NUMBER", "INT32", "DECIMAL", "INT16", "DOUBLE"
                    C11595DataType(iC11595 + 1) = AKBTypeConst.cAKBTypeNumeric
                Case "DATE", "TIMESTAMP"
                    C11595DataType(iC11595 + 1) = AKBTypeConst.cAKBTypeDate
                Case "CHAR", "VARCHAR2", "LONG"
                    C11595DataType(iC11595 + 1) = AKBTypeConst.cAKBTypeString
                End Select
            Next iC11595
        RsC11595_EOF = Not RsC11595.Read()
    ...
    Comp_C11596:
        ...
        Dim tb_C11596 As DataTable = New DataTable()
        tb_C11596.Columns.Add("Nome Pessoa" & "")
        tb_C11596.Columns.Add("Código Pessoa" & "")
        tb_C11596.Columns.Add("Abreviatura" & "")
        tb_C11596.Columns.Add("Cidade" & "")
        tb_C11596.Columns.Add("Cód Estab Faturamento" & "")
        ReDim ReturnDatatype(RsC11595.FieldCount)
        Do Until RsC11595_EOF
            Dim row_C11596 As DataRow = tb_C11596.NewRow()
            Dim iC11596 As Short
            For iC11596 = 0 To RsC11595.FieldCount - 1
                row_C11596(iC11596) = RsC11595(iC11596)
                ReturnDatatype(iC11596 + 1) = C11595DataType(iC11596)
            Next iC11596
            tb_C11596.Rows.Add(row_C11596)
            RsC11595_EOF = Not RsC11595.Read()
        Loop
        R1770 = tb_C11596
    ...
    Comp_C260427:
        ...
        C260427DataType = 3
        C260427 = Mid(con.ConnectionString, InStr(con.ConnectionString, "User Id=")+8, Instr(InStr(con.ConnectionString, "User Id="), con.ConnectionString, ";")-InStr(con.ConnectionString, "User Id=")-8)
        GoTo Comp_C11595
